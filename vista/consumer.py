...
channel.queue_declare(queue='vista2',durable=True)#anadir durable=True para que los mensaje lleguen a pesar de que este apagado#implementa el protocolo de mensajeria AMQP para declarar una cola.
...
channel.basic_consume(queue='vista2', on_message_callback=callback, auto_ack=True)
